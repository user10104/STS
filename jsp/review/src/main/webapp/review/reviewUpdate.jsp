...
<br><br>
<input type = "submit" value = "등록" class = "submit-btn" onclick="return reviewCheck()">
<input type = "reset" value = "다시 작성" class = "submit-btn">
<input type = "button" value = "목록" class = "submit-btn" onclick="location.href='ReviewServlet?command=review_list'">
</form>
</div>
</body>
</html>
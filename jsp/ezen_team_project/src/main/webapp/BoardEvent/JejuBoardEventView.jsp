...
<body>
   ...
   <div id="wrap" align="center">
      ...
      <table>
         ...
         <tr>
            <th>작성자</th>
            <td colspan="3">${JejuBoardEvent.nickname}</td>
         </tr>
         <tr>
            <th>내용</th>
            ...
            <td colspan="3">
               <c:choose>
                  <c:when test="${empty JejuBoardEvent.event_PictureUrl1}">
                     <img src="C:/works/JSP/.metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps/Jeju/upload/JejuBoardNotice_VO_Table.png">
                  </c:when>
                  <c:otherwise>
           			 <img src="upload/${JejuBoardEvent.event_PictureUrl1}" alt="noimage"> 
      ...
      <input type="button" value="게시글 삭제" class="submit-btn"
         onclick="location.href='Servlet?command=Jeju_EventDelete&event_index=${JejuBoardEvent.event_index}'">

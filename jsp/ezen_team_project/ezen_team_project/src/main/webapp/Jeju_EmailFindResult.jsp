	...
	<div class="main-container">
		<div class="main-wrap">
			...
			<section class="login-input-section-wrap">
				...
				<c:choose>
      			<c:when test="${not empty getEmail}">
      				
      					<h4>회원님의 이메일은  ${getEmail} 입니다</h4>
      					<%                                                                                       
				...
				<div class="login-button-wrap">
					<button style='cursor:pointer;' id="IDFIND" onClick="return id_search()">이메일 찾기</button>
				</div>

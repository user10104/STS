   ...
   <div id="wrap" align="center">
      ...
      <form method="post" enctype="multipart/form-data" name="frm">
         <input type="hidden" name="code" value="${product.code}"> <input
            type="hidden" name="nonmakeImg" value="${product.picturesurl}">
         <table>
            <tr>
               <td><c:choose>
                     <c:when test="${empty product.picturesurl}">
                        <img src="upload/noimage.gif">
                     </c:when>
                     <c:otherwise>
                        <img src="upload/${product.picturesurl}">
                     </c:otherwise>
                  </c:choose></td>
               <td>
                  <table>
                     ...
                     <tr>
                        <th>사 진</th>
                        <td><input type="file" name=picturesurl><br>

         ...
         <table>
            ...
            <tr>
               ...
               <td><input type="text" size="40" maxlength="50" name="email"
                  value="${Servlet.email}"></td>
            </tr>
            <tr>
               <th>제목</th>
               <td><input type="text" size="70" name="title"
                  value="${Servlet.title}"></td>
            </tr>
            <tr>
               <th>내용</th>
               <td><textarea cols="70" rows="15" name="content">${Servlet.content}</textarea></td>
            </tr>
         </table>
         <br>
         <br> <input type="submit" value="등록" class="submit-btn" onclick="return JejuCheck()">

      ...
      <table class="list">
         ...
         <c:forEach var="JejuBoardNoticeList" items="${JejuBoardNoticeList}">
            <tr class="record">
               ...
               <td><a href="JejuBoredServlet?command=Jeju_view&Notice_index=${JejuBoardNoticeList.notice_index}">
                     ${JejuBoardNoticeList.title } </a></td>
               <td>${JejuBoardNoticeList.admin_name}</td>
               <td><fmt:formatDate value="${JejuBoardNoticeList.writedate}" /></td>
               <td>${JejuBoardNoticeList.readcount}</td>
            </tr>
         </c:forEach>
          <tr>

         ...
         <table>
            <tr>
               ...
               <td><input type="text" size="12" name="name"
                  value="${Jeju_NoticeList.name}"> * 필수</td>
            </tr>
            <tr>
               <th>비밀번호</th>
            ...
            <tr>
               ...
               <td><input type="text" size="40" maxlength="50" name="email"
                  value="${Jeju_NoticeList.email}"></td>
            </tr>
            <tr>
               <th>제목</th>
               <td><input type="text" size="70" name="title"
                  value="${Jeju_NoticeList.title}"></td>
            </tr>
            <tr>
               <th>내용</th>
               <td><textarea cols="70" rows="15" name="content">${Jeju_NoticeList.content}</textarea></td>
            </tr>
         </table>
         <br>

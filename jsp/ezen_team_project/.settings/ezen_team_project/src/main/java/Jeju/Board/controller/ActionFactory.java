...
public class ActionFactory {
	...
	public Action getAction(String command) {
		...
		else if(command.equals("JejuReviewWrite_Form")) {	//리뷰
			action = new JejuReviewWriteFormAction();
		}else if(command.equals("Jeju_Review_List")) {	
			action = new JejuReviewListAction();
		}else if(command.equals("JejuReview_write")) {	
			action = new JejuReviewWriteAction();
		}else if(command.equals("Jeju_ReviewView")) {
			action = new JejuReviewViewAction();
		}else if(command.equals("Jeju_ReviewDelete")) {
			action = new JejuReviewDeleteAction();
